...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Feb 2021 pada 12.44
...
(2, 8, 9, '2021-02-13', '2021-02-27', 10000000, 0, 0, 'Belum Lunas'),
...
INSERT INTO `skb_job_order` (`Jo_id`, `mobil_no`, `supir_id`, `muatan`, `asal`, `tujuan`, `uang_jalan`, `terbilang`, `tanggal_surat`, `tanggal_bongkar`, `tonase`, `keterangan`, `harga/kg`, `upah`, `biaya_lain`, `Keterangan_biaya_lain`, `customer_id`, `status`, `bonus`, `status_upah`) VALUES
...
INSERT INTO `skb_mobil` (`mobil_no`, `mobil_jenis`, `mobil_max_load`, `status_jalan`, `status_hapus`) VALUES
...
('BE 1510 YY', 'Fuso', 7, 'Tidak Jalan', 'NO'),
('BE 2213 AA', 'Grand Max', 3, 'Tidak Jalan', 'NO'),
('BE 3322 AS', 'Wing Box', 10, 'Tidak Jalan', 'NO'),
...
(5, 'Dwiki Martin', 0, 'Tidak Jalan', 'NO'),
...
--
ALTER TABLE `skb_bon`
  MODIFY `bon_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `skb_invoice`
  MODIFY `invoice_kode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT untuk tabel `skb_job_order`
--
ALTER TABLE `skb_job_order`
  MODIFY `Jo_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;

--
-- AUTO_INCREMENT untuk tabel `skb_supir`
--
ALTER TABLE `skb_supir`
  MODIFY `supir_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
